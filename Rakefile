...
namespace :cordova do
  ...
  task :prepare do
    ...
    sh %{ cd #{CORDOVA_PATH}; cordova platform rm android; cordova platform add android; cordova-update-config --appname "#{app_name}" --appid #{app_id} --appversion #{app_version} }
