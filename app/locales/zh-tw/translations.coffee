I18nTranslationsEn =
  ...
  "search": "搜尋"
  "QuotaExceededError": "網頁未能於Safari 的 <b>隱私模式.</b> 運作。 請嘗試/br><ul><li><a href='https://itunes.apple.com/in/app/goodcitystock.hk/id1144806764?mt=8' style='color: black!important; background-color: #dee4eb !important;'>　下載iOS 應用程式</a></li><li> 正在使用Safari 正常(非隱私)模式</li><li> 正在使用Chrome 的隱私瀏覽模式</li></ul>"
  "search_min": "搜尋 (最少三位數字)"
  "cancel": "取消"
  "ok" : "確定"
  "must_login": "必需登入!"
  "search_no_results": "抱歉, 並無搜尋結果。"
  "version": "版本"
