...
moduleForModel('designation', 'Designation model',{
  needs: ['model:order-transport', 'model:gc_organisation' ,'model:contact', 'model:organisation', 'model:local_order', 'model:item', 'model:orders_package', 'model:location', 'model:code', 'model:donor_condition', 'model:set_item', 'model:packages_location', 'model:image']
});
